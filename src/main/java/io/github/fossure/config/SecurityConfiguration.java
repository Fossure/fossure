...
import io.github.fossure.security.jwt.JWTConfigurer;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        boolean fossology = true;
        if (fossology) {
            // Open Fossology endpoint if enabled in config
            http.authorizeRequests().antMatchers("/api/v1/fossology/**").permitAll();
        }
