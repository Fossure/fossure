package io.github.fossure.service.helper.copyright;
...
public class ArchiveHelper {
     ...
     * If the archive type is unknown or unsupported an {@link io.github.fossure.service.exceptions.ArchiveException ArchiveException}
     * will be thrown.
     *
     ...
     * @throws io.github.fossure.service.exceptions.ArchiveException ArchiveException if the archive compression or
     * type is unknown or unsupported
     */
    public static Copyright analyseForCopyright(InputStream input, boolean inAllFiles)
        throws io.github.fossure.service.exceptions.ArchiveException {
        try {
     ...
     * @return a {@link Copyright} with full and simple Sets of copyrights. If the a Set is empty, than no copyright was found
     * @throws io.github.fossure.service.exceptions.ArchiveException if the archive cannot be read or the archive is not a file or unsupported
     */
    private static Copyright searchForCopyright(InputStream input, boolean inAllFiles)
        ...
        try {
            ...
            throw new io.github.fossure.service.exceptions.ArchiveException(
