...
import io.github.fossure.repository.GenericLicenseUrlRepository;
...
public class GenericLicenseUrlResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new genericLicenseUrl,
     * or with status {@code 400 (Bad Request)} if the genericLicenseUrl has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the genericLicenseUrl,
