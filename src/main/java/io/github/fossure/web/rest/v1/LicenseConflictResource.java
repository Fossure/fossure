...
import io.github.fossure.repository.LicenseConflictRepository;
...
public class LicenseConflictResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new licenseConflict,
     * or with status {@code 400 (Bad Request)} if the licenseConflict has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the licenseConflict,
