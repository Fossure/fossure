...
import io.github.fossure.repository.LicenseNamingMappingRepository;
...
public class LicenseNamingMappingResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new licenseNamingMapping,
     * or with status {@code 400 (Bad Request)} if the licenseNamingMapping has already an ID.
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the licenseNamingMapping,
