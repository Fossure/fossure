...
import io.github.fossure.service.LicensePerLibraryService;
import io.github.fossure.service.criteria.LicensePerLibraryCriteria;
import io.github.fossure.service.criteria.query.LicensePerLibraryQueryService;
...
public class LicensePerLibraryResource {
     ...
     * @return the {@link ResponseEntity} with status {@code 201 (Created)} and with body the new licensePerLibrary,
     * or with status {@code 400 (Bad Request)} if the licensePerLibrary has already an ID.
    ...
    public ResponseEntity<List<LicensePerLibrary>> getAllLicensePerLibraries(
        @ParameterObject LicensePerLibraryCriteria criteria,
     ...
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the licensePerLibrary,
