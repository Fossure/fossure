...
import { LibraryPerProductService } from 'app/entities/library-per-product/service/library-per-product.service';
...
export class ProductDetailComponent implements OnInit, AfterViewInit {
  ...
  delete(libraryPerProduct: ILibraryPerProduct): void {
    const modalRef = this.modalService.open(LibraryPerProductDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
